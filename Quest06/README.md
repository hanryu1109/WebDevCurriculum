...
- 인터넷은 어떻게 동작하나요? Internet Protocol Suite의 레이어 모델에 입각하여 설명해 보세요.
  ...
  > - Internet Protocol Suite란 인터넷에서 컴퓨터들이 서로 정보를 주고받는 데 쓰이는 통신규약(프로토콜)의 모음입니다.
  ...
  - 근거리에서 서로 떨어진 두 전자기기가 유선/무선으로 서로 통신하는 프로토콜은 어떻게 동작할까요?
    ...
    > - 이더넷 환경에서 LAN 프로토콜 종로 중 하나인 CSMA/CD(Carrier Sense Multiple Access/Collision Detetion) 프로토콜을 이용합니다.
    > - Ethernet(이더넷)은 OSI 모델의 물리 계층에서 신호와 배선, 데이터 링크 계층에서 MAC 패킷과 프로토콜의 형식을 정의합니다.
  ...
  - 근거리에 있는 여러 대의 전자기기가 서로 통신하는 프로토콜은 어떻게 동작할까요?
    ...
    > - 이러한 무선 통신 기술을 이용하여 여러 대의 전자기기가 서로 통신하는 방법은 크게 두 가지로 나눌 수 있습니다.
    > - 첫째, Ad-hoc 모드로 무선 네트워크를 구성하는 방법입니다. 이 방법은 무선 랜 어댑터를 이용하여 각각의 전자기기가 서로 통신할 수 있는 무선 네트워크를 직접 구성하는 방법입니다. 이 방법은 인터넷이나 다른 외부 네트워크와의 연결이 필요 없는 경우에 주로 사용됩니다. 예를 들어, 무선 프린터나 스마트폰과 노트북 사이의 파일 전송 등에 이용됩니다.
    > - 둘째, Infrastructure 모드로 무선 액세스 포인트를 이용하여 네트워크를 구성하는 방법입니다. 이 방법은 무선 액세스 포인트를 중심으로 여러 대의 전자기기가 연결되어 구성된 네트워크입니다. 무선 액세스 포인트는 유선 네트워크와 연결되어 인터넷이나 다른 외부 네트워크와의 연결을 제공하며, 여러 대의 전자기기가 무선으로 연결될 수 있습니다. 이 방법은 주로 공공장소나 건물 내에서 사용되는 Wi-Fi 네트워크 등에 이용됩니다.
    > - 이러한 무선 통신 기술에서는 각각의 전자기기가 고유한 식별자인 MAC 주소를 가지고 있으며, 이를 이용하여 다른 전자기기와의 통신을 할 수 있습니다. 또한, 각각의 무선 통신 기술은 각기 다른 프로토콜을 이용하여 통신하며, 이를 이용하여 데이터를 주고받습니다.
...
- 두 전자기기가 신뢰성을 가지고 통신할 수 있도록 하기 위한 프로토콜은 어떻게 동작할까요?
  ...
  > - 신뢰성을 가지고 통신한다는 의미는 데이터가 누락이 되지 않고 오류 없이 제대로 전송이 되는 것을 의미합니다.
  > - 대표적인 예로는 TCP(Transmission Control Protocol)가 있습니다.
